...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d83dd8c5-bdc9-4b06-b98d-027caba9f2e1",
...
const _lazy_SaFmKy = () => import('../routes/api/mcp.get.mjs');
const _lazy_AU5kCc = () => import('../routes/api/mcp.options.mjs');
const _lazy_9AhEEN = () => import('../routes/api/mcp.post.mjs');
const _lazy_S0kSeY = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/mcp', handler: _lazy_SaFmKy, lazy: true, middleware: false, method: "get" },
  { route: '/api/mcp', handler: _lazy_AU5kCc, lazy: true, middleware: false, method: "options" },
  { route: '/api/mcp', handler: _lazy_9AhEEN, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_S0kSeY, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_S0kSeY, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, listener as A, setResponseStatus as a, defineRenderHandler as b, createError$1 as c, defineEventHandler as d, encodePath as e, destr as f, getQuery as g, getRouteRules as h, joinURL as i, joinRelativeURL as j, getResponseStatusText as k, getResponseStatus as l, useNitroApp as m, defu as n, hasProtocol as o, parseQuery as p, parseURL as q, readBody as r, setResponseHeaders as s, decodePath as t, useRuntimeConfig as u, isScriptProtocol as v, withQuery as w, withTrailingSlash as x, withoutTrailingSlash as y, sanitizeStatusCode as z };
