...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		path: "/arc",
		meta: { layout: "default" },
		component: () => import('../build/arc-D7W9oeBg.mjs')
	},
	{
		name: "ensemble",
		path: "/ensemble",
		meta: { layout: "default" },
		component: () => import('../build/ensemble-f7RgcaRO.mjs')
	},
	{
		name: "mcp",
		path: "/mcp",
		meta: { layout: "default" },
		component: () => import('../build/mcp-DD8esf3t.mjs')
	},
	{
		name: "openskill",
		path: "/openskill",
		meta: { layout: "default" },
		component: () => import('../build/openskill-Dn3YCpbI.mjs')
	},
	{
		name: "ordinal-replica",
		path: "/ordinal-replica",
		meta: { layout: "default" },
		component: () => import('../build/ordinal-replica-D89Mkphi.mjs')
	},
	{
		name: "provenance",
		path: "/provenance",
		meta: { layout: "default" },
		component: () => import('../build/provenance-CwPf01Rr.mjs')
	},
	{
		name: "resume",
		path: "/resume",
		meta: { layout: "default" },
		component: () => import('../build/resume-n31qyLWf.mjs')
	},
	{
		name: "index",
		path: "/",
		meta: { layout: "default" },
		component: () => import('../build/pages-q6c65hEx.mjs')
	}
];
//#endregion
	...
	/* @__PURE__ */ defineNuxtPlugin(() => {
		...
		useHead$1({
			...
			meta: [
				...
				{
					property: "og:url",
					content: () => canonicalFor(route.path)
				},
				{
					property: "og:title",
					content: siteName
				...
				},
				{
					...
					content: "Vivek Joshy — Lead Scientist, Data & ML at Vairified Corp"
				},
				{
					name: "twitter:card",
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-BhkN6B2N.mjs').then((m) => m.default || m)) };
//#endregion
...
var error_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		const detail = computed(() => status.value === 404 ? "That page doesn't exist, or it moved." : props.error?.statusMessage || "An unexpected error occurred.");
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))}><div class="max-w-md"><p class="text-7xl sm:text-8xl font-black text-accent tick mb-2">${ssrInterpolate(status.value)}</p><h1 class="text-2xl font-semibold mb-4">${ssrInterpolate(heading.value)}</h1><p class="mb-8 text-subheading">${ssrInterpolate(detail.value)}</p>`);
			_push(ssrRenderComponent(_component_NuxtLink, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Return home`);
					else return [createTextVNode("Return home")];
				}),
				_: 1
			}, _parent));
			_push(`</div></div>`);
...
export { NuxtLink as N, useRouter as a, entry as e, useHead$1 as u };
