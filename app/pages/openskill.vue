  ...
  <div class="py-8 max-w-5xl mx-auto">
    <div class="mb-10">
      ...
      <p class="text-subheading">
        ...
        <a href="https://github.com/vivekjoshy/vivekjoshy.com/blob/main/scripts/verify-openskill.mjs" target="_blank" rel="noopener noreferrer" class="text-accent link-underline">check</a>
        and the
        <a href="https://github.com/vivekjoshy/vivekjoshy.com/blob/main/scripts/gen-openskill-reference.py" target="_blank" rel="noopener noreferrer" class="text-accent link-underline">generator</a>
